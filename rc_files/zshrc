...
alias rm='nocorrect rm -i -r'   # no spelling correction on rm and ask for confirmation
...
# SSH Completion
users=(hlefevre paluche)
hosts=(ssh.enst.fr a406-01.enst.fr a406-10.enst.fr paluche-laptop)
